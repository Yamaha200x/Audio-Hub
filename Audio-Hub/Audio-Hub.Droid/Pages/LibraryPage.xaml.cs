...
public partial class LibraryPage : ContentPage
{
    ...
    private async void LoadData()
    {
        try
        {
            ...
            // Hier sp�ter die Daten an die Views binden
        }
        catch (Exception ex)
        {
    ...
    // Event Handler f�r Filter-Chip �nderung
    ...
    // Event Handler f�r Suchbutton
    private async void OnSearchClicked(object sender, EventArgs e)
    {
        await DisplayAlert("Suche", "Suchfunktion wird ge�ffnet", "OK");
    }

    // Event Handler f�r "Neue Playlist" Button
    private async void OnNewPlaylistClicked(object sender, TappedEventArgs e)
    {
        string playlistName = await DisplayPromptAsync(
            "Neue Playlist",
            "Gib einen Namen f�r die Playlist ein:",
    ...
    // Event Handler f�r "Meine Favoriten" Button
    ...
    // Event Handler f�r Item-Klick (Folder, Playlist, Artist, Album, Podcast)
    ...
    // Event Handler f�r More-Button (drei Punkte)
    private async void OnMoreOptionsClicked(object sender, EventArgs e)
    {
        ...
        string action = await DisplayActionSheet(
            ...
            null,
            "Abspielen",
            "Als N�chstes abspielen",
            "Zur Warteschlange hinzuf�gen",
        ...
        switch (action)
        {
            case "Abspielen":
                ...
                break;
            case "Als N�chstes abspielen":
                // TODO: Zur Queue hinzuf�gen (n�chster Song)
                break;
            case "Zur Warteschlange hinzuf�gen":
                // TODO: Zur Queue hinzuf�gen (am Ende)
                break;
            case "Zur Playlist hinzuf�gen":
                // TODO: Playlist-Auswahl Dialog
                break;
            case "Zu Favoriten hinzuf�gen":
                // TODO: Zu Favoriten hinzuf�gen
                break;
            case "Teilen":
                // TODO: Share-Dialog �ffnen
                break;
            case "Details anzeigen":
                // TODO: Detail-Seite �ffnen
                break;
        }
    }
}